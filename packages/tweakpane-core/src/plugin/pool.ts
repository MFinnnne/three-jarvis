...
import {createInputBindingController, InputBindingPlugin} from '../input-binding/plugin';
import {isEmpty} from '../misc/type-util';
import {createMonitorBindingController, MonitorBindingPlugin} from '../monitor-binding/plugin';
...
export class PluginPool {
	...
	public createInput(document: Document, target: BindingTarget, params: InputParams): InputBindingController<unknown> {
	...
	public createMonitor(document: Document, target: BindingTarget, params: MonitorParams): MonitorBindingController<unknown> {
	...
	public createBlade(document: Document, params: Record<string, unknown>): BladeController<View> {
	...
	public createBladeApi(bc: BladeController<View>): BladeApi<BladeController<View>> {
