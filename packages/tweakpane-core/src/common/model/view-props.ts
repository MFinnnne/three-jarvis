...
function valueToModifier(elem: HTMLElement, modifier: string): (value: boolean) => void {
...
export class ViewProps extends ValueMap<ViewPropsObject> {
	...
	constructor(valueMap: {
		...
		this.get('parent')?.globalDisabled.emitter.on('change', this.onParentGlobalDisabledChange_);
	}
