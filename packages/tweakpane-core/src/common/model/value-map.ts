...
export class ValueMap<O extends Record<string, unknown>> {
	...
	public static createCore<O extends Record<string, unknown>>(initialValue: O): ValueMapCore<O> {
	...
	public static fromObject<O extends Record<string, unknown>>(initialValue: O): ValueMap<O> {
