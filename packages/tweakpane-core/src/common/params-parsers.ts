...
function parseArray<T>(value: unknown[], parseItem: ParamsParser<T>): T[] | undefined {
...
function createParamsParserBuilder<T>(parse: (value: unknown) => T | undefined): ParamsParserBuilder<T> {
	return (optional) => (v) => {
...
function createParamsParserBuilders(optional: boolean) {
	return {
		custom: <T>(parse: (value: unknown) => T | undefined) => createParamsParserBuilder(parse)(optional),

		boolean: createParamsParserBuilder<boolean>((v) => (typeof v === 'boolean' ? v : undefined))(optional),

		number: createParamsParserBuilder<number>((v) => (typeof v === 'number' ? v : undefined))(optional),

		string: createParamsParserBuilder<string>((v) => (typeof v === 'string' ? v : undefined))(optional),
		...
		constant: <T>(value: T) => createParamsParserBuilder<T>((v) => (v === value ? value : undefined))(optional),
...
export function parseParams<O extends Record<string, unknown>>(value: Record<string, unknown>, keyToParserMap: {[Key in keyof O]: ParamsParser<O[Key]>}): O | undefined {
