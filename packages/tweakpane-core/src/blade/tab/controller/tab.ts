...
import {NestedOrderedSet, NestedOrderedSetEvents} from '../../common/model/nested-ordered-set';
...
export class TabController extends RackLikeController<TabView> {
	...
	private onPageAdd_(ev: NestedOrderedSetEvents<TabPageController>['add']): void {
		const pc = ev.item;
	...
	private onPageRemove_(ev: NestedOrderedSetEvents<TabPageController>['remove']): void {
		const pc = ev.item;
