...
import {assertDisposes, assertInitialState, assertUpdates} from '../../common/api/test-util';
...
describe(ButtonApi.name, () => {
	...
	it('should listen click event', (done) => {
		...
		api.controller_.valueController.view.buttonElement.dispatchEvent(TestUtil.createEvent(win, 'click'));
	});
