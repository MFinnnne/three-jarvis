...
import {addButtonAsBlade, addFolderAsBlade, addSeparatorAsBlade, addTabAsBlade, BladeRackApi} from '../../common/api/blade-rack';
...
export function findSubBladeApiSet(api: BladeApi<BladeController<View>>): NestedOrderedSet<BladeApi<BladeController<View>>> | null {
...
function getApiByController(apiSet: NestedOrderedSet<BladeApi<BladeController<View>>>, controller: BladeController<View>): BladeApi<BladeController<View>> {
...
function createBindingTarget<O extends Bindable, Key extends keyof O>(obj: O, key: Key, opt_id?: string): BindingTarget {
...
export class RackApi extends BladeApi<RackController> implements BladeRackApi {
	...
	public addInput<O extends Bindable, Key extends keyof O>(object: O, key: Key, opt_params?: InputParams): InputBindingApi<unknown, O[Key]> {
	...
	public addMonitor<O extends Bindable, Key extends keyof O>(object: O, key: Key, opt_params?: MonitorParams): MonitorBindingApi<O[Key]> {
		const params = opt_params ?? {};
		const doc = this.controller_.view.element.ownerDocument;
	...
	public add<A extends BladeApi<BladeController<View>>>(api: A, opt_index?: number): A {
	...
	public on<EventName extends keyof BladeRackApiEvents>(eventName: EventName, handler: (ev: BladeRackApiEvents[EventName]['event']) => void): this {
