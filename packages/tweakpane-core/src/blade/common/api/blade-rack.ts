...
export function addButtonAsBlade(api: BladeRackApi, params: ButtonParams): ButtonApi {
	return api.addBlade({
		...params,
		view: 'button',
	}) as ButtonApi;
...
export function addFolderAsBlade(api: BladeRackApi, params: FolderParams): FolderApi {
	return api.addBlade({
		...params,
		view: 'folder',
	}) as FolderApi;
...
export function addSeparatorAsBlade(api: BladeRackApi, opt_params?: SeparatorParams): SeparatorApi {
