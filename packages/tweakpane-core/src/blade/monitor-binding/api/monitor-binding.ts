 ...
 */
export class MonitorBindingApi<T> extends BladeApi<MonitorBindingController<T>> {
	...
	public on<EventName extends keyof MonitorBindingApiEvents<T>>(eventName: EventName, handler: (ev: MonitorBindingApiEvents<T>[EventName]['event']) => void): MonitorBindingApi<T> {
