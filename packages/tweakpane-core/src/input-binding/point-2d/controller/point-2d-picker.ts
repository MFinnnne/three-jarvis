...
import {PointerData, PointerHandler, PointerHandlerEvents} from '../../../common/view/pointer-handler';
...
function computeOffset(ev: KeyboardEvent, baseSteps: [number, number], invertsY: boolean): [number, number] {
