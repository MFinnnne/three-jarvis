...
export function createDimensionConstraint(params: PointDimensionParams | undefined, initialValue: number): Constraint<number> | undefined {
	if (!params) {
		return undefined;
	}
...
function createConstraint(params: Point2dInputParams, initialValue: Point2dObject): Constraint<Point2d> {
...
function getSuitableMaxDimensionValue(constraint: Constraint<number> | undefined, rawValue: number): number {
 ...
 * @hidden
 */
export function getSuitableMaxValue(initialValue: Point2d, constraint: Constraint<Point2d> | undefined): number {
...
function createAxis(initialValue: number, constraint: Constraint<number> | undefined) {
	return {
 ...
 * @hidden
 */
export const Point2dInputPlugin: InputBindingPlugin<Point2d, Point2dObject, Point2dInputParams> = {
	id: 'input-point2d',
	type: 'input',
	accept: (value, params) => {
