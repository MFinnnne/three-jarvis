...
function createConstraint(params: Point3dInputParams, initialValue: Point3dObject): Constraint<Point3d> {
 ...
 * @hidden
 */
export const Point3dInputPlugin: InputBindingPlugin<Point3d, Point3dObject, Point3dInputParams> = {
	id: 'input-point3d',
	type: 'input',
	accept: (value, params) => {
