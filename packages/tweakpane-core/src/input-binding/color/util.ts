...
export function parseColorInputParams(params: Record<string, unknown>): ColorInputParams | undefined {
 ...
 * @hidden
 */
export function extractColorType(params: ColorInputParams): ColorType | undefined {
