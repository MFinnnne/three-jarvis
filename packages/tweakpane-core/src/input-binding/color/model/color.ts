...
import {appendAlphaComponent, ColorComponents3, ColorComponents4, ColorMode, ColorType, constrainColorComponents, convertColor, removeAlphaComponent} from './color-model';
...
export class Color {
	...
	public static fromObject(obj: RgbColorObject | RgbaColorObject, type: ColorType = 'int'): Color {
		const comps: ColorComponents4 | ColorComponents3 = 'a' in obj ? [obj.r, obj.g, obj.b, obj.a] : [obj.r, obj.g, obj.b];
		return new Color(comps, 'rgb', type);
	}

	public static toRgbaObject(color: Color, type: ColorType = 'int'): RgbaColorObject {
	...
	public static isColorObject(obj: unknown): obj is RgbColorObject | RgbaColorObject {
	...
	constructor(comps: ColorComponents3 | ColorComponents4, mode: ColorMode, type: ColorType = 'int') {
		this.mode = mode;
		this.type = type;
		this.comps_ = constrainColorComponents(comps, mode, type);
	}

	public getComponents(opt_mode?: ColorMode, type: ColorType = 'int'): ColorComponents4 {
		return appendAlphaComponent(convertColor(removeAlphaComponent(this.comps_), {mode: this.mode, type: this.type}, {mode: opt_mode ?? this.mode, type}), this.comps_[3]);
	}
