 ...
 * @hidden
 */
export const StringColorInputPlugin: InputBindingPlugin<Color, string, ColorInputParams> = {
	...
	binding: {
		reader: (args) => createColorStringBindingReader(extractColorType(args.params) ?? 'int'),
		equals: Color.equals,
		writer: (args) => {
