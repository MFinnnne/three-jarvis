...
function createAxisController<PointNd>(doc: Document, config: Config<PointNd>, index: number): NumberTextController {
 ...
 * @hidden
 */
export class PointNdTextController<PointNd> implements Controller<PointNdTextView> {
