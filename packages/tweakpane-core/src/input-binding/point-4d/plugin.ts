...
function createConstraint(params: Point4dInputParams, initialValue: Point4dObject): Constraint<Point4d> {
 ...
 * @hidden
 */
export const Point4dInputPlugin: InputBindingPlugin<Point4d, Point4dObject, Point4dInputParams> = {
	id: 'input-point4d',
	type: 'input',
	accept: (value, params) => {
