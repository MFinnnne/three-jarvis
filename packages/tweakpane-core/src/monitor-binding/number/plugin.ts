...
function createTextMonitor(args: Parameters<MonitorBindingPlugin<number, NumberMonitorParams>['controller']>[0]) {
...
function createGraphMonitor(args: Parameters<MonitorBindingPlugin<number, NumberMonitorParams>['controller']>[0]): Controller<View> {
 ...
 * @hidden
 */
export const NumberMonitorPlugin: MonitorBindingPlugin<number, NumberMonitorParams> = {
	id: 'monitor-number',
	type: 'monitor',
	accept: (value, params) => {
