...
!(function (t, e) {
	...
	class c {
		constructor(t) {
			var e;
			(this.message =
				null !== (e = d[t.type](t.context)) && void 0 !== e
					? e
					: 'Unexpected error'),
		...
		static propertyNotFound(t) {
			return new c({type: 'propertynotfound', context: {name: t}});
		}
	...
	class h {
		...
		writeProperty(t, e) {
			const n = this.read();
			if (!h.isBindable(n)) throw c.notBindable();
	...
	function _(t, e) {
		var n, i;
		t.emitter.on('change', ((n = g), (i = e), (t) => i(n(t)))), e(t.rawValue);
	}
	function f(t, e, n) {
		_(t.value(e), n);
	}
	...
	class P {
		constructor(t, e) {
			(this.emitter = new v()),
				...
				(this.view = new y(t, {props: this.props, viewProps: this.viewProps})),
	...
	class k {
		...
		setRawValue(t, e) {
			const n =
					null != e ? e : {forceEmit: !1, beforeChange: !1, emit: !0, last: !0},
	...
	class E {
		constructor(t) {
			(this.emitter = new v()), (this.value_ = t);
		}
		get rawValue() {
			return this.value_;
		}
		...
		setRawValue(t, e) {
			const n =
					null != e ? e : {forceEmit: !1, beforeChange: !1, last: !0, emit: !0},
				i = this.value_;
			(i !== t || n.forceEmit) &&
				(this.emitter.emit('beforechange', {sender: this}),
				(this.value_ = t),
	...
	function V(t, e) {
		...
		return n || i ? new k(t, e) : new E(t);
	}
	class L {
		constructor(t) {
			(this.emitter = new v()), (this.valMap_ = t);
	...
	function S(t) {
		return {
			custom: (e) => M(e)(t),
			boolean: M((t) => ('boolean' == typeof t ? t : void 0))(t),
			number: M((t) => ('number' == typeof t ? t : void 0))(t),
			string: M((t) => ('string' == typeof t ? t : void 0))(t),
			function: M((t) => ('function' == typeof t ? t : void 0))(t),
			constant: (e) => M((t) => (t === e ? e : void 0))(t),
			raw: M((t) => t)(t),
			object: (e) =>
				M((t) => {
					var n;
	...
	const A = {optional: S(!0), required: S(!1)};
	function D(t, e) {
		const n = A.required.object(e)(t);
	...
	class N extends L {
		constructor(t) {
			...
			super(t),
				...
				([this.globalDisabled_, this.setGlobalDisabled_] = R.create(
					V(this.getGlobalDisabled_()),
				)),
		...
		bindClassModifiers(t) {
			_(this.globalDisabled_, K(t, 'disabled')),
				f(this, 'hidden', K(t, 'hidden'));
		}
		bindDisabled(t) {
			_(this.globalDisabled_, (e) => {
				t.disabled = e;
			});
		}
		bindTabIndex(t) {
		...
		constructor(t) {
			...
			this.blade.value('positions').emitter.on('change', () => {
				['veryfirst', 'first', 'last', 'verylast'].forEach((t) => {
					e.classList.remove(O(void 0, U[t]));
				}),
					this.blade.get('positions').forEach((t) => {
						e.classList.add(O(void 0, U[t]));
					});
			}),
		...
		set parent(t) {
			(this.parent_ = t),
				'parent' in this.viewProps.valMap_
					...
					: j({key: 'parent', target: N.name, place: 'BladeController.parent'});
		}
	}
	...
	function q(t, e) {
		const n = t.createElementNS(T, 'svg');
		return (n.innerHTML = z[e]), n;
	}
	function G(t, e, n) {
	...
	class W {
		constructor(t, e) {
			(this.element = t.createElement('div')),
				this.element.classList.add(J()),
				e.viewProps.bindClassModifiers(this.element);
			const n = t.createElement('div');
			n.classList.add(J('l')),
				f(e.props, 'label', (e) => {
					a(e)
						? this.element.classList.add(J(void 0, 'nol'))
						: (this.element.classList.remove(J(void 0, 'nol')),
						  (function (t) {
		...
		constructor(t, e) {
			...
			super(
				Object.assign(Object.assign({}, e), {
					view: new W(t, {props: e.props, viewProps: n}),
					viewProps: n,
				}),
			),
				(this.props = e.props),
	...
	const tt = {
		...
		controller: (t) =>
			new Z(t.document, {
				blade: t.blade,
				props: L.fromObject({label: t.params.label}),
				valueController: new P(t.document, {
					props: L.fromObject({title: t.params.title}),
					viewProps: t.viewProps,
				}),
			}),
		api: (t) =>
			t.controller instanceof Z && t.controller.valueController instanceof P
				? new u(t.controller)
				: null,
	};
	class et extends B {
	...
	function nt() {
		return new L({positions: V([], {equals: l})});
	}
	class it extends L {
		constructor(t) {
			super(t);
		...
		get styleHeight() {
			...
			return this.get('shouldFixHeight') && !a(t) ? `${t}px` : 'auto';
		}
		bindExpandedClass(t, e) {
			const n = () => {
				this.styleExpanded ? t.classList.add(e) : t.classList.remove(e);
			};
			f(this, 'expanded', n), f(this, 'temporaryExpanded', n);
		}
		cleanUpTransition() {
	...
	class lt extends e {
		...
		setValue(t, e = !0) {
			this.controller_.binding.setValue(t, e);
		}
		refresh() {
		...
		onBindingChange_(t) {
			var e;
			const n = t.sender.target.read();
			t.options.beforeChange && (this.exBeforeChangeFalg = !0),
				!t.options.beforeChange &&
					this.exBeforeChangeFalg &&
					(null === (e = this.beforeChangeEventHandler) ||
						void 0 === e ||
						e.call(this),
					(this.exBeforeChangeFalg = !1)),
				t.options.emit &&
	...
	function vt(t, e, n) {
		if (!h.isBindable(t)) throw c.notBindable();
		return new h(t, e, n);
	}
	class mt extends e {
		constructor(t, e) {
		...
		get children() {
			return this.controller_.rack.children.map((t) => ut(this.apiSet_, t));
		}
		addInput(t, e, n) {
			const i = null != n ? n : {},
				s = this.controller_.view.element.ownerDocument,
				o = this.pool_.createInput(s, vt(t, e, i.presetKey), i),
				r = new lt(o);
		...
		addMonitor(t, e, n) {
			const i = null != n ? n : {},
				s = this.controller_.view.element.ownerDocument,
				o = this.pool_.createMonitor(s, vt(t, e), i),
				r = new dt(o);
			return this.add(r, i.index);
		}
		addFolder(t) {
		...
		onRackRemove_(t) {
			if (t.isRoot) {
				const e = ut(this.apiSet_, t.bladeController);
		...
		onRackMonitorUpdate_(t) {
			if (!(t.bladeController instanceof ct)) throw c.shouldNeverHappen();
			const e = ut(this.apiSet_, t.bladeController),
	...
	class bt extends rt {
		constructor(t, e) {
			super(t, new mt(t.rackController, e)),
				(this.emitter_ = new v()),
	...
	class xt {
		...
		onChildInputChange_(t) {
			const e = (function (t, e) {
				for (let n = 0; n < t.length; n++) {
					const i = t[n];
					if (i instanceof pt && i.binding === e) return i;
				}
				return null;
			})(this.find(pt), t.sender);
		...
		onChildMonitorUpdate_(t) {
			const e = (function (t, e) {
				for (let n = 0; n < t.length; n++) {
					const i = t[n];
					if (i instanceof ct && i.binding === e) return i;
				}
				return null;
		...
		onChildValueChange_(t) {
			const e = (function (t, e) {
				for (let n = 0; n < t.length; n++) {
					const i = t[n];
					if (i instanceof et && i.value === e) return i;
				}
				return null;
			})(this.find(et), t.sender);
			if (!e) throw c.alreadyDisposed();
			this.emitter.emit('inputchange', {
				bladeController: e,
				options: t.options,
	...
	class Ct extends B {
		constructor(t, e) {
			super(
				Object.assign(Object.assign({}, e), {
					view: new _t(t, {viewName: 'brk', viewProps: e.viewProps}),
				}),
			),
				(this.onRackAdd_ = this.onRackAdd_.bind(this)),
				(this.onRackRemove_ = this.onRackRemove_.bind(this));
		...
		onRackAdd_(t) {
			t.isRoot && G(this.view.element, t.bladeController.view.element, t.index);
		}
		onRackRemove_(t) {
			t.isRoot && Y(t.bladeController.view.element);
		}
	}
	const yt = b('cnt');
	class Pt {
		constructor(t, e) {
			var n;
			(this.className_ = b(
				null !== (n = e.viewName) && void 0 !== n ? n : 'fld',
			)),
				(this.element = t.createElement('div')),
				this.element.classList.add(this.className_(), yt()),
				e.viewProps.bindClassModifiers(this.element),
				...
				f(
					this.foldable_,
					'completed',
					w(this.element, this.className_(void 0, 'cpl')),
				);
	...
	class kt extends gt {
		constructor(t, e) {
			var n;
			const i = it.create(null === (n = e.expanded) || void 0 === n || n),
				s = new Ct(t, {blade: e.blade, root: e.root, viewProps: e.viewProps});
			super(
				Object.assign(Object.assign({}, e), {
					rackController: s,
					view: new Pt(t, {
				...
				(this.props = e.props),
				(this.foldable = i),
				ot(this.foldable, this.view.containerElement),
	...
	const Et = {
		...
		api: (t) =>
			t.controller instanceof kt ? new bt(t.controller, t.pool) : null,
	};
	class Vt extends et {
		constructor(t, e) {
			const n = e.valueController.viewProps;
	...
	class St {
		constructor(t, e) {
			...
			n.classList.add(Mt('r')), this.element.appendChild(n);
		}
	}
	class At extends B {
		constructor(t, e) {
			super(
				Object.assign(Object.assign({}, e), {
					view: new St(t, {viewProps: e.viewProps}),
				}),
			);
		}
	}
	const Dt = {
			...
			type: 'blade',
			accept(t) {
				const e = D(t, {view: A.required.constant('separator')});
				return e ? {params: e} : null;
			},
			controller: (t) =>
				new At(t.document, {blade: t.blade, viewProps: t.viewProps}),
			api: (t) => (t.controller instanceof At ? new Lt(t.controller) : null),
		},
		jt = b('tbi');
	class Rt {
		constructor(t, e) {
			(this.element = t.createElement('div')),
				...
				e.viewProps.bindClassModifiers(this.element),
				f(e.props, 'selected', (t) => {
					t
						? this.element.classList.add(jt(void 0, 'sel'))
						: this.element.classList.remove(jt(void 0, 'sel'));
				});
			const n = t.createElement('button');
			n.classList.add(jt('b')),
				e.viewProps.bindDisabled(n),
				this.element.appendChild(n),
				(this.buttonElement = n);
			const i = t.createElement('div');
			i.classList.add(jt('t')),
				x(e.props.value('title'), i),
				this.buttonElement.appendChild(i),
				(this.titleElement = i);
		}
	...
	class It {
		constructor(t, e) {
			(this.emitter = new v()),
				...
				(this.props = e.props),
				(this.viewProps = e.viewProps),
				(this.view = new Rt(t, {props: e.props, viewProps: e.viewProps})),
				this.view.buttonElement.addEventListener('click', this.onClick_);
		}
		onClick_() {
			this.emitter.emit('click', {sender: this});
	...
	class Kt {
		constructor(t, e) {
			(this.onItemClick_ = this.onItemClick_.bind(this)),
				(this.ic_ = new It(t, {props: e.itemProps, viewProps: N.create()})),
				this.ic_.emitter.on('click', this.onItemClick_),
				(this.cc_ = new Ct(t, {blade: nt(), viewProps: N.create()})),
				(this.props = e.props),
				f(this.props, 'selected', (t) => {
	...
	class Ot extends rt {
		...
		addPage(t) {
			const e = this.controller_.view.element.ownerDocument,
				n = new Kt(e, {
					itemProps: L.fromObject({selected: !1, title: t.title}),
					props: L.fromObject({selected: !1}),
				});
			this.controller_.add(n, t.index);
			const i = this.pageApiMap_.get(n);
			if (!i) throw c.shouldNeverHappen();
			return i;
		}
		removePage(t) {
		...
		onPageRemove_(t) {
			if (!this.pageApiMap_.get(t.item)) throw c.shouldNeverHappen();
			this.pageApiMap_.delete(t.item);
		}
		onSelect_(t) {
			this.emitter_.emit('select', {event: new r(this, t.rawValue)});
		}
	}
	class Ut {
		constructor() {
	...
	class Tt {
		constructor(t, e) {
			(this.element = t.createElement('div')),
				this.element.classList.add(Bt(), yt()),
				e.viewProps.bindClassModifiers(this.element),
				_(e.empty, w(this.element, Bt(void 0, 'nop')));
			const n = t.createElement('div');
			n.classList.add(Bt('t')),
				this.element.appendChild(n),
				(this.itemsElement = n);
			const i = t.createElement('div');
			i.classList.add(Bt('i')), this.element.appendChild(i);
			const s = e.contentsElement;
			s.classList.add(Bt('c')),
	...
	class Ft extends gt {
		constructor(t, e) {
			const n = new Ct(t, {blade: e.blade, viewProps: e.viewProps}),
				i = new Ut();
			super({
				blade: e.blade,
				rackController: n,
		...
		onPageAdd_(t) {
			const e = t.item;
			G(this.view.itemsElement, e.itemController.view.element, t.index),
		...
		onPageRemove_(t) {
			const e = t.item;
			Y(e.itemController.view.element),
	...
	const $t = {
		...
		controller(t) {
			const e = new Ft(t.document, {blade: t.blade, viewProps: t.viewProps});
			return (
				t.params.pages.forEach((n) => {
					const i = new Kt(t.document, {
						itemProps: L.fromObject({selected: !1, title: n.title}),
						props: L.fromObject({selected: !1}),
					});
					e.add(i);
				}),
		...
		api: (t) =>
			t.controller instanceof Ft ? new Ot(t.controller, t.pool) : null,
	};
	class Ht {
		constructor() {
	...
	class Yt {
		constructor(t) {
			this.values = L.fromObject({max: t.max, min: t.min});
		}
		constrain(t) {
	...
	class Xt {
		constructor(t) {
			this.values = L.fromObject({options: t});
		}
		get options() {
	...
	class Qt {
		...
		constrain(t) {
			const e = this.values.get('max'),
				n = this.values.get('min');
			let i = t;
			return a(n) || (i = Math.max(i, n)), a(e) || (i = Math.min(i, e)), i;
		}
	}
	class Jt {
		constructor(t, e = 0) {
	...
	class Zt {
		constructor(t, e) {
			...
			n.classList.add(Wt('s')),
				f(this.props_, 'options', (e) => {
					X(n),
						e.forEach((e, i) => {
	...
	class ne {
		constructor(t, e) {
			(this.element = t.createElement('div')),
				...
				e.viewProps.bindClassModifiers(this.element),
				_(e.shows, w(this.element, ee(void 0, 'v')));
		}
	}
	class ie {
		constructor(t, e) {
			(this.shows = V(!1)),
				(this.viewProps = e.viewProps),
				(this.view = new ne(t, {shows: this.shows, viewProps: this.viewProps}));
		}
	}
	const se = b('txt');
	class oe {
	...
	class re {
		...
		onInputChange_(t) {
			const e = t.currentTarget.value,
				n = this.parser_(e);
			a(n) || (this.value.rawValue = n), this.view.refresh();
		}
	}
	function ae(t) {
		return 'false' !== t && !!t;
	...
	const he = {'+': (t) => t, '-': (t) => -t, '~': (t) => ~t};
	class ue {
		constructor(t, e) {
			(this.operator = t), (this.expression = e);
		}
		evaluate() {
			const t = he[this.operator];
	...
	const fe = ve([
		function (t, e) {
			...
			const s = be(t, e);
			return n + i + s + ge(t, (e += s.length));
		},
		function (t, e) {
			const n = t.substr(e, 1);
			if (((e += n.length), '.' !== n)) return '';
			const i = be(t, e);
			return (e += i.length), '' === i ? '' : n + i + ge(t, e);
		},
		function (t, e) {
			const n = _e(t, e);
			return (e += n.length), '' === n ? '' : n + ge(t, e);
		},
	]);
	const we = ve([
			function (t, e) {
	...
	function Ce(t, e) {
		...
		return null !==
			(n = (function (t, e) {
				const n = xe(t, e);
				return (
					(e += n.length), '' === n ? null : {evaluable: new pe(n), cursor: e}
				);
			})(t, e)) && void 0 !== n
			? n
			: (function (t, e) {
	...
	function ye(t, e, n) {
		...
		return i
			? ((n += i.length), {cursor: (n += me(e, n).length), operator: i})
			: null;
	}
	const Pe = [
		['**'],
			...
			(function (t, e) {
				return (n, i) => {
					...
					for (;;) {
						...
						const r = t(n, i);
						if (!r) return null;
						(i = r.cursor), (o = new ce(s.operator, o, r.evaluable));
					}
		...
		function t(e, n) {
			...
			const o = t(e, n);
			return o
				? {cursor: (n = o.cursor), evaluable: new ue(s, o.evaluable)}
				: null;
		},
	);
	function ke(t, e) {
		return (e += me(t, e).length), Pe(t, e);
	}
	function Ee(t) {
		var e;
		const n = (function (t) {
			const e = ke(t, 0);
			return e
				? e.cursor + me(t, e.cursor).length !== t.length
					? null
					: e.evaluable
				: null;
		})(t);
	...
	function Ne({primary: t, secondary: e, forward: n, backward: i}) {
		let s = !1;
		function o(t) {
			s || ((s = !0), t(), (s = !1));
		}
	...
	function Fe(t, e) {
		...
		return {
			x:
				t.pageX -
				((null !== (n = s && s.scrollX) && void 0 !== n ? n : 0) + o.left),
			y:
				t.pageY -
				((null !== (i = s && s.scrollY) && void 0 !== i ? i : 0) + o.top),
		};
	}
	class $e {
		constructor(t) {
		...
		onMouseDown_(t) {
			...
			n.addEventListener('mousemove', this.onDocumentMouseMove_),
				...
				this.emitter.emit('down', {
					altKey: t.altKey,
					data: this.computePosition_(Fe(t, this.elem_)),
					sender: this,
					shiftKey: t.shiftKey,
				});
		}
	...
	class Xe {
		constructor(t, e) {
			...
			const i = t.createElement('div');
			i.classList.add(Ye('k')),
				this.element.appendChild(i),
				(this.knobElement = i);
			const s = t.createElementNS(T, 'svg');
			s.classList.add(Ye('g')), this.knobElement.appendChild(s);
			const o = t.createElementNS(T, 'path');
			o.classList.add(Ye('gb')), s.appendChild(o), (this.guideBodyElem_ = o);
			const r = t.createElementNS(T, 'path');
			r.classList.add(Ye('gh')), s.appendChild(r), (this.guideHeadElem_ = r);
		...
		onDraggingChange_(t) {
			if (null === t.rawValue)
				return void this.element.classList.remove(Ye(void 0, 'drg'));
	...
	class Qe {
		constructor(t, e) {
			...
			const i = new $e(this.view.knobElement);
		...
		constrainValue_(t) {
			...
			let o = t;
			return (
				void 0 !== i && (o = Math.max(o, i)),
				void 0 !== s && (o = Math.min(o, s)),
				o
			);
		}
		onInputChange_(t) {
			const e = t.currentTarget.value,
				n = this.parser_(e);
			a(n) || (this.value.rawValue = this.constrainValue_(n)),
				this.view.refresh();
		}
		onInputKeyDown_(t) {
			const e = Oe(this.baseStep_, Ue(t));
			0 !== e &&
	...
	class We {
		constructor(t, e) {
			(this.onChange_ = this.onChange_.bind(this)),
				...
				e.viewProps.bindClassModifiers(this.element);
			const n = t.createElement('div');
			n.classList.add(Je('t')),
				e.viewProps.bindTabIndex(n),
				this.element.appendChild(n),
				(this.trackElement = n);
			const i = t.createElement('div');
			i.classList.add(Je('k')),
	...
	class Ze {
		constructor(t, e) {
			(this.onKeyDown_ = this.onKeyDown_.bind(this)),
				...
				(this.ptHandler_ = new $e(this.view.trackElement)),
		...
		onKeyDown_(t) {
			const e = Oe(this.baseStep_, Be(t));
			0 !== e &&
	...
	class en {
		constructor(t, e) {
			(this.element = t.createElement('div')), this.element.classList.add(tn());
			const n = t.createElement('div');
			n.classList.add(tn('s')),
	...
	function pn(t) {
		return a(t) ? null : new Xt(ln(t));
	}
	function dn(t, e) {
		const n = t && Gt(t, Jt);
		return n ? ze(n.step) : Math.max(ze(e), 2);
	}
	function cn(t) {
		const e = (function (t) {
			const e = t ? Gt(t, Jt) : null;
	...
	class vn {
		constructor(t, e) {
			...
			n.classList.add(un('l')), this.element.appendChild(n);
			const i = t.createElement('input');
			i.classList.add(un('i')),
				(i.type = 'checkbox'),
				n.appendChild(i),
				(this.inputElement = i),
				e.viewProps.bindDisabled(this.inputElement);
			const s = t.createElement('div');
			s.classList.add(un('w')), n.appendChild(s);
			const o = q(t, 'check');
			s.appendChild(o),
				e.value.emitter.on('change', this.onValueChange_),
				(this.value = e.value),
	...
	class mn {
		constructor(t, e) {
			(this.onInputChange_ = this.onInputChange_.bind(this)),
				(this.value = e.value),
				(this.viewProps = e.viewProps),
				(this.view = new vn(t, {value: this.value, viewProps: this.viewProps})),
				this.view.inputElement.addEventListener('change', this.onInputChange_);
		}
		onInputChange_(t) {
	...
	const bn = {
			...
			accept: (t, e) => {
				...
				const n = D(e, {options: A.optional.custom(on)});
			...
			controller: (t) => {
				...
				return s
					? new te(e, {
							props: new L({options: s.values.value('options')}),
							value: n,
							viewProps: t.viewProps,
					  })
	...
	class _n {
		constructor(t, e) {
			(this.element = t.createElement('div')),
				...
				e.foldable.bindExpandedClass(this.element, gn(void 0, 'expanded')),
				f(e.foldable, 'completed', w(this.element, gn(void 0, 'cpl')));
			const n = t.createElement('div');
			n.classList.add(gn('h')), this.element.appendChild(n);
			const i = t.createElement('div');
			i.classList.add(gn('s')), n.appendChild(i), (this.swatchElement = i);
			const s = t.createElement('div');
			if (
	...
	function Pn(t, e, n, i) {
		const s = yn(e, n),
			o = yn(e, i);
		return t.map((t, e) => (t / s[e]) * o[e]);
	}
	function kn(t, e) {
		return 'object' == typeof t && !a(t) && e in t && 'number' == typeof t[e];
	}
	class En {
		constructor(t, e, n = 'int') {
			(this.mode = e),
				(this.type = n),
				(this.comps_ = (function (t, e, n) {
					var i;
					const s = yn(e, n);
					return [
						'rgb' === e
							? qe(t[0], 0, s[0])
							: ((o = t[0]), (r = s[0]), o === r ? r : Ge(o, r)),
						qe(t[1], 0, s[1]),
						qe(t[2], 0, s[2]),
						qe(null !== (i = t[3]) && void 0 !== i ? i : 1, 0, 1),
					];
					var o, r;
				})(t, e, n));
		}
		static black(t = 'int') {
			return new En([0, 0, 0], 'rgb', t);
		}
		static fromObject(t, e = 'int') {
			const n = 'a' in t ? [t.r, t.g, t.b, t.a] : [t.r, t.g, t.b];
			return new En(n, 'rgb', e);
		}
		static toRgbaObject(t, e = 'int') {
			return t.toRgbaObject(e);
		}
		static isRgbColorObject(t) {
			return kn(t, 'r') && kn(t, 'g') && kn(t, 'b');
		}
		static isRgbaColorObject(t) {
			return this.isRgbColorObject(t) && kn(t, 'a');
		}
		...
		getComponents(t, e = 'int') {
			return xn(
				(function (t, e, n) {
					const i = Pn(t, e.mode, e.type, 'int');
					return Pn(Cn[e.mode][n.mode](...i), n.mode, 'int', n.type);
				})(
					wn(this.comps_),
	...
	class Ln {
		constructor(t, e) {
			...
			if (
				...
				const n = t.createElement('div');
				n.classList.add(Vn('a'));
				const i = t.createElement('div');
				i.classList.add(Vn('ap')),
					i.appendChild(this.alphaViews_.palette.element),
					n.appendChild(i);
				const s = t.createElement('div');
				s.classList.add(Vn('at')),
	...
	function Sn(t) {
		...
		return D(t, {
			...
			color: e.optional.object({
				alpha: e.optional.boolean,
				type: e.optional.custom(Mn),
			}),
			expanded: e.optional.boolean,
			picker: e.optional.custom(rn),
		});
	}
	function An(t) {
		return t ? 0.1 : 1;
	...
	function Kn(t) {
		...
		if (!e) return null;
		const n = [jn(e[1], 255), jn(e[2], 255), jn(e[3], 255)];
		return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) ? null : n;
	}
	function Nn(t) {
		return (e) => {
			const n = Kn(e);
			return n ? new En(n, 'rgb', t) : null;
		};
	}
	function On(t) {
		const e = t.match(
		...
		if (!e) return null;
		const n = [jn(e[1], 255), jn(e[2], 255), jn(e[3], 255), jn(e[4], 1)];
	...
	function Bn(t) {
		...
		if (!e) return null;
		const n = [In(e[1]), jn(e[2], 100), jn(e[3], 100)];
		return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) ? null : n;
	}
	function Tn(t) {
		return (e) => {
			const n = Bn(e);
			return n ? new En(n, 'hsl', t) : null;
		};
	}
	function Fn(t) {
		const e = t.match(
		...
		if (!e) return null;
		const n = [In(e[1]), jn(e[2], 100), jn(e[3], 100), jn(e[4], 1)];
		return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) || isNaN(n[3]) ? null : n;
	}
	function $n(t) {
		return (e) => {
	...
	function zn(t) {
		...
		if (e)
			return [
				...
				parseInt(e[2] + e[2], 16),
				parseInt(e[3] + e[3], 16),
				He(parseInt(e[4] + e[4], 16), 0, 255, 0, 1),
			];
		const n = t.match(
	...
	const Qn = [
		{parser: Hn, result: {alpha: !1, mode: 'rgb', notation: 'hex'}},
		{parser: zn, result: {alpha: !0, mode: 'rgb', notation: 'hex'}},
		{parser: Kn, result: {alpha: !1, mode: 'rgb', notation: 'func'}},
		{parser: On, result: {alpha: !0, mode: 'rgb', notation: 'func'}},
		{parser: Bn, result: {alpha: !1, mode: 'hsl', notation: 'func'}},
		{parser: Fn, result: {alpha: !0, mode: 'hsl', notation: 'func'}},
		{parser: qn, result: {alpha: !1, mode: 'rgb', notation: 'object'}},
		{parser: Yn, result: {alpha: !0, mode: 'rgb', notation: 'object'}},
	];
	function Jn(t, e = 'int') {
		const n = (function (t) {
			return Qn.reduce(
	...
	const Wn = {
		int: [
			function (t) {
				const e = Hn(t);
				return e ? new En(e, 'rgb', 'int') : null;
			},
			function (t) {
				const e = zn(t);
				return e ? new En(e, 'rgb', 'int') : null;
	...
	function Zn(t) {
		const e = Wn[t];
		return (t) => e.reduce((e, n) => e || n(t), null);
	}
	function ti(t) {
		const e = qe(Math.floor(t), 0, 255).toString(16);
		return 1 === e.length ? `0${e}` : e;
	}
	function ei(t, e = '#') {
		return `${e}${wn(t.getComponents('rgb')).map(ti).join('')}`;
	}
	function ni(t, e = '#') {
		const n = t.getComponents('rgb');
		return `${e}${[n[0], n[1], n[2], 255 * n[3]].map(ti).join('')}`;
	}
	function ii(t, e) {
		const n = Me('float' === e ? 2 : 0);
		return `rgb(${wn(t.getComponents('rgb', e))
			.map((t) => n(t))
			.join(', ')})`;
	}
	function si(t) {
	...
	function ai(t, e) {
		const n = Me('float' === e ? 2 : 0),
			i = ['r', 'g', 'b'];
		return `{${wn(t.getComponents('rgb', e))
			.map((t, e) => `${i[e]}: ${n(t)}`)
			.join(', ')}}`;
	}
	function li(t) {
	...
	const ci = [
		...
		},
		{
			...
			stringifier: function (t) {
				const e = [Me(0), Ae, Ae];
				return `hsl(${wn(t.getComponents('hsl'))
					.map((t, n) => e[n](t))
					.join(', ')})`;
			},
		},
	...
	class vi {
		constructor(t, e) {
			...
			const n = t.createElement('div');
			n.classList.add(ui('b')), this.element.appendChild(n);
			const i = t.createElement('div');
			i.classList.add(ui('c')), n.appendChild(i), (this.colorElem_ = i);
			const s = t.createElement('div');
			s.classList.add(ui('m')),
				this.element.appendChild(s),
				(this.markerElem_ = s);
			const o = t.createElement('div');
		...
		update_() {
			const t = this.value.rawValue,
				...
				n = new En([e[0], e[1], e[2], 0], 'rgb'),
				i = new En([e[0], e[1], e[2], 255], 'rgb'),
				s = ['to right', oi(n), oi(i)];
			(this.colorElem_.style.background = `linear-gradient(${s.join(',')})`),
				(this.previewElem_.style.backgroundColor = oi(t));
			const o = He(e[3], 0, 1, 0, 100);
	...
	class mi {
		constructor(t, e) {
			(this.onKeyDown_ = this.onKeyDown_.bind(this)),
				...
				(this.value = e.value),
				(this.viewProps = e.viewProps),
				(this.view = new vi(t, {value: this.value, viewProps: this.viewProps})),
				(this.ptHandler_ = new $e(this.view.element)),
				this.ptHandler_.emitter.on('down', this.onPointerDown_),
				this.ptHandler_.emitter.on('move', this.onPointerMove_),
				this.ptHandler_.emitter.on('up', this.onPointerUp_),
		...
		handlePointerEvent_(t, e) {
			...
			this.value.setRawValue(new En([s, o, r, n], 'hsv'), e);
		}
		onPointerDown_(t) {
			this.handlePointerEvent_(t.data, {
				forceEmit: !1,
		...
		onKeyDown_(t) {
			const e = Oe(An(!0), Be(t));
			if (0 === e) return;
			const n = this.value.rawValue,
				[i, s, o, r] = n.getComponents('hsv');
			this.value.setRawValue(new En([i, s, o, r + e], 'hsv'), {
				forceEmit: !1,
				beforeChange: !1,
				emit: !0,
				last: !1,
	...
	function fi(t, e, n) {
		return new Qe(t, {
			...
			props: L.fromObject({
				...
				formatter: ((i = e.colorType), Me('float' === i ? 2 : 0)),
			}),
			value: V(0, {constraint: _i(e.colorMode, e.colorType, n)}),
			viewProps: e.viewProps,
		});
		var i;
	}
					...
					Ne({
						...
						backward: (t, n) => {
							const i = this.colorMode.rawValue,
								s = t.rawValue.getComponents(i, this.colorType_);
							return (
								(s[e] = n.rawValue), new En(xn(wn(s), s[3]), i, this.colorType_)
							);
						},
					});
				}),
	...
	class Ci {
		...
		update_() {
			...
			this.markerElem_.style.backgroundColor = ii(new En([e, 100, 100], 'hsv'));
			const n = He(e, 0, 360, 0, 100);
	...
	class yi {
		constructor(t, e) {
			(this.onKeyDown_ = this.onKeyDown_.bind(this)),
				...
				(this.value = e.value),
				(this.viewProps = e.viewProps),
				(this.view = new Ci(t, {value: this.value, viewProps: this.viewProps})),
				(this.ptHandler_ = new $e(this.view.element)),
				this.ptHandler_.emitter.on('down', this.onPointerDown_),
				this.ptHandler_.emitter.on('move', this.onPointerMove_),
				this.ptHandler_.emitter.on('up', this.onPointerUp_),
		...
		handlePointerEvent_(t, e) {
			if (!t.point) return;
			const n = He(qe(t.point.x, 0, t.bounds.width), 0, t.bounds.width, 0, 360),
				i = this.value.rawValue,
				[, s, o, r] = i.getComponents('hsv');
			this.value.setRawValue(new En([n, s, o, r], 'hsv'), e);
		}
		onPointerDown_(t) {
			this.handlePointerEvent_(t.data, {
				forceEmit: !1,
		...
		onKeyDown_(t) {
			const e = Oe(An(!1), Be(t));
			if (0 === e) return;
			const n = this.value.rawValue,
				[i, s, o, r] = n.getComponents('hsv');
			this.value.setRawValue(new En([i + e, s, o, r], 'hsv'), {
				forceEmit: !1,
				beforeChange: !1,
				emit: !0,
				last: !1,
	...
	class ki {
		constructor(t, e) {
			...
			(n.height = 64),
				(n.width = 64),
				n.classList.add(Pi('c')),
				this.element.appendChild(n),
				(this.canvasElement = n);
			const i = t.createElement('div');
			i.classList.add(Pi('m')),
				this.element.appendChild(i),
				(this.markerElem_ = i),
				this.update_();
		}
		update_() {
			...
			const r = He(e[1], 0, 100, 0, 100);
			this.markerElem_.style.left = `${r}%`;
			const a = He(e[2], 0, 100, 100, 0);
	...
	class Ei {
		...
		handlePointerEvent_(t, e) {
			if (!t.point) return;
			const n = He(t.point.x, 0, t.bounds.width, 0, 100),
				i = He(t.point.y, 0, t.bounds.height, 100, 0),
				[s, , , o] = this.value.rawValue.getComponents('hsv');
			this.value.setRawValue(new En([s, n, i, o], 'hsv'), e);
		}
		onPointerDown_(t) {
			this.handlePointerEvent_(t.data, {
				forceEmit: !1,
		...
		onKeyDown_(t) {
			Te(t.key) && t.preventDefault();
			const [e, n, i, s] = this.value.rawValue.getComponents('hsv'),
				o = An(!1),
				r = Oe(o, Be(t)),
				a = Oe(o, Ue(t));
			(0 === r && 0 === a) ||
				this.value.setRawValue(new En([e, n + r, i + a, s], 'hsv'), {
					forceEmit: !1,
					beforeChange: !1,
					emit: !0,
					last: !1,
	...
	class Vi {
		constructor(t, e) {
			(this.value = e.value),
				(this.viewProps = e.viewProps),
				(this.hPaletteC_ = new yi(t, {
					value: this.value,
					viewProps: this.viewProps,
				})),
				(this.svPaletteC_ = new Ei(t, {
					value: this.value,
					viewProps: this.viewProps,
				})),
				(this.alphaIcs_ = e.supportsAlpha
					? {
							...
							text: new Qe(t, {
								parser: Ee,
								baseStep: 0.1,
								props: L.fromObject({draggingScale: 0.01, formatter: Me(2)}),
								value: V(0, {constraint: new Yt({min: 0, max: 1})}),
								viewProps: this.viewProps,
							}),
					  }
					: null),
				this.alphaIcs_ &&
					Ne({
						...
						backward: (t, e) => {
							...
							return (n[3] = e.rawValue), new En(n, t.rawValue.mode);
						},
					}),
				(this.textC_ = new wi(t, {
	...
	class Mi {
		constructor(t, e) {
			(this.onValueChange_ = this.onValueChange_.bind(this)),
				...
				e.viewProps.bindClassModifiers(this.element);
			const n = t.createElement('div');
			n.classList.add(Li('sw')),
				this.element.appendChild(n),
				(this.swatchElem_ = n);
			const i = t.createElement('button');
			i.classList.add(Li('b')),
				e.viewProps.bindDisabled(i),
				this.element.appendChild(i),
				(this.buttonElement = i),
				this.update_();
		...
		update_() {
			const t = this.value.rawValue;
			this.swatchElem_.style.backgroundColor = ni(t);
		}
		onValueChange_() {
			this.update_();
		}
	...
	class Si {
		constructor(t, e) {
			(this.value = e.value),
				(this.viewProps = e.viewProps),
				(this.view = new Mi(t, {value: this.value, viewProps: this.viewProps}));
		}
	}
	class Ai {
		constructor(t, e) {
			(this.onButtonBlur_ = this.onButtonBlur_.bind(this)),
				...
				(this.value = e.value),
				(this.viewProps = e.viewProps),
				(this.foldable_ = it.create(e.expanded)),
			...
			n.addEventListener('blur', this.onButtonBlur_),
				...
				(this.textC_ = new re(t, {
					parser: e.parser,
					props: L.fromObject({formatter: e.formatter}),
					value: this.value,
					viewProps: this.viewProps,
				})),
				(this.view = new _n(t, {
				...
				(this.popC_ =
					'popup' === e.pickerLayout
						? new ie(t, {viewProps: this.viewProps})
						: null);
			const i = new Vi(t, {
				colorType: e.colorType,
				supportsAlpha: e.supportsAlpha,
			...
			i.view.allFocusableElements.forEach((t) => {
				...
				this.popC_
					...
					: this.view.pickerElement &&
					  ...
					  ot(this.foldable_, this.view.pickerElement));
		}
		get textController() {
			return this.textC_;
		}
		...
		onPopupChildBlur_(t) {
			...
			const e = this.popC_.view.element,
				n = Q(t);
			(n && e.contains(n)) ||
				(n && n === this.swatchC_.view.buttonElement && !$(e.ownerDocument)) ||
	...
	function Di(t) {
		return wn(t.getComponents('rgb')).reduce(
	...
	function Ri(t) {
		return 'number' != typeof t
			? En.black()
			: new En([((e = t) >> 16) & 255, (e >> 8) & 255, 255 & e], 'rgb');
		var e;
	}
	function Ii(t) {
		return 'number' != typeof t
	...
	function Ui(t) {
		return (e) =>
			(function (t, e) {
				return En.isColorObject(t) ? En.fromObject(t, e) : En.black(e);
			})(e, t);
	}
	function Bi(t, e) {
		return (n) => (t ? pi(n, e) : ai(n, e));
	}
	const Ti = {
			id: 'input-color-object',
			type: 'input',
			accept: (t, e) => {
				if (!En.isColorObject(t)) return null;
				const n = Sn(e);
				return n ? {initialValue: t, params: n} : null;
			},
			binding: {
				reader: (t) => Ui(Dn(t.params)),
				equals: En.equals,
				writer: (t) => {
					return (
						(i = t.initialValue),
						(e = En.isRgbaColorObject(i)),
						(n = Dn(t.params)),
						(t, i) => {
							e
								? (function (t, e, n) {
										const i = e.toRgbaObject(n);
		...
		Fi = {
			...
			binding: {
				reader: (t) => {
					...
					return (function (t) {
						const e = Wn[t];
						return (n) => {
							if ('string' != typeof n) return En.black(t);
							const i = e.reduce((t, e) => t || e(n), null);
							return null != i ? i : En.black(t);
						};
					})(null !== (e = Dn(t.params)) && void 0 !== e ? e : 'int');
				},
				equals: En.equals,
				writer: (t) => {
					const e = Jn(t.initialValue, Dn(t.params));
					if (!e) throw c.shouldNeverHappen();
					const n = (function (t) {
						const e = hi(t);
						return e
			...
			controller: (t) => {
				...
				const n = hi(e);
				if (!n) throw c.shouldNeverHappen();
				const i = 'expanded' in t.params ? t.params.expanded : void 0,
					s = 'picker' in t.params ? t.params.picker : void 0;
				return new Ai(t.document, {
					colorType: e.type,
					expanded: null != i && i,
	...
	class qi {
		constructor(t, e) {
			(this.value = e.value),
				...
				(this.acs_ = e.axes.map((n, i) =>
					(function (t, e, n) {
						return new Qe(t, {
							...
							value: V(0, {constraint: e.axes[n].constraint}),
							viewProps: e.viewProps,
						});
					})(t, e, i),
				)),
				...
				(this.view = new zi(t, {textViews: this.acs_.map((t) => t.view)}));
		}
	}
	function Gi(t, e) {
		return 'step' in t && !a(t.step) ? new Jt(t.step, e) : null;
	}
	function Yi(t) {
		return a(t.max) || a(t.min)
			? a(t.max) && a(t.min)
				? null
				: new Qt({max: t.max, min: t.min})
			: new Yt({max: t.max, min: t.min});
	}
	const Xi = {
		id: 'input-number',
		type: 'input',
		...
		binding: {
			...
			constraint: (t) =>
				(function (t, e) {
					...
					const s = Yi(t);
					s && n.push(s);
					const o = pn(t.options);
					return o && n.push(o), new qt(n);
		...
		controller: (t) => {
			...
			return r
				? new nn(t.document, {
						...
						textProps: L.fromObject({
							draggingScale: hn(i, n.rawValue),
							formatter: o,
						}),
						value: n,
						viewProps: t.viewProps,
	...
	class Zi {
		constructor(t, e) {
			(this.element = t.createElement('div')),
				...
				e.viewProps.bindClassModifiers(this.element),
				_(e.expanded, w(this.element, Wi(void 0, 'expanded')));
			const n = t.createElement('div');
			n.classList.add(Wi('h')), this.element.appendChild(n);
			const i = t.createElement('button');
			i.classList.add(Wi('b')),
				i.appendChild(q(t, 'p2dpad')),
				e.viewProps.bindDisabled(i),
				n.appendChild(i),
				(this.buttonElement = i);
			const s = t.createElement('div');
			if (
				(s.classList.add(Wi('t')),
				n.appendChild(s),
				(this.textElement = s),
				'inline' === e.pickerLayout)
			) {
				const e = t.createElement('div');
				e.classList.add(Wi('p')),
					this.element.appendChild(e),
					(this.pickerElement = e);
			} else this.pickerElement = null;
		}
	...
	class es {
		constructor(t, e) {
			(this.onFoldableChange_ = this.onFoldableChange_.bind(this)),
				...
				'popup' === e.layout && this.element.classList.add(ts(void 0, 'p')),
				e.viewProps.bindClassModifiers(this.element);
			const n = t.createElement('div');
			n.classList.add(ts('p')),
				e.viewProps.bindTabIndex(n),
				this.element.appendChild(n),
				(this.padElement = n);
			const i = t.createElementNS(T, 'svg');
			i.classList.add(ts('g')),
				this.padElement.appendChild(i),
				(this.svgElem_ = i);
			const s = t.createElementNS(T, 'line');
			s.classList.add(ts('ax')),
			...
			const o = t.createElementNS(T, 'line');
			o.classList.add(ts('ax')),
	...
	function ns(t, e, n) {
		return [Oe(e[0], Be(t)), Oe(e[1], Ue(t)) * (n ? 1 : -1)];
	}
	class is {
		constructor(t, e) {
			(this.onPadKeyDown_ = this.onPadKeyDown_.bind(this)),
				...
				(this.ptHandler_ = new $e(this.view.padElement)),
				this.ptHandler_.emitter.on('down', this.onPointerDown_),
				this.ptHandler_.emitter.on('move', this.onPointerMove_),
				this.ptHandler_.emitter.on('up', this.onPointerUp_),
		...
		handlePointerEvent_(t, e) {
			...
			const n = this.maxValue_,
				i = He(t.point.x, 0, t.bounds.width, -n, +n),
				s = He(
			...
			this.value.setRawValue(new Qi(i, s), e);
		}
		onPointerDown_(t) {
			this.handlePointerEvent_(t.data, {
				forceEmit: !1,
		...
		onPadKeyDown_(t) {
			Te(t.key) && t.preventDefault();
			const [e, n] = ns(t, this.baseSteps_, this.invertsY_);
			(0 === e && 0 === n) ||
				this.value.setRawValue(
					new Qi(this.value.rawValue.x + e, this.value.rawValue.y + n),
					{forceEmit: !1, beforeChange: !1, emit: !0, last: !1},
				);
		}
		onPadKeyUp_(t) {
			const [e, n] = ns(t, this.baseSteps_, this.invertsY_);
	...
	class ss {
		...
		onPopupChildBlur_(t) {
			...
			const e = this.popC_.view.element,
				n = Q(t);
			(n && e.contains(n)) ||
				(n && n === this.view.buttonElement && !$(e.ownerDocument)) ||
				(this.popC_.shows.rawValue = !1);
		}
		onPopupChildKeydown_(t) {
			this.popC_
	...
	const ls = {
		toComponents: (t) => t.getComponents(),
		fromComponents: (t) => new as(...t),
	};
	function ps(t) {
		return Qi.isObject(t) ? new Qi(t.x, t.y) : new Qi();
	}
	function ds(t, e) {
	...
	function hs(t, e) {
		const [n, i] = t
			...
			: [];
		if (!a(n) || !a(i))
			return Math.max(Math.abs(null != n ? n : 0), Math.abs(null != i ? i : 0));
		const s = cn(t);
		return Math.max(10 * Math.abs(s), 10 * Math.abs(e));
	}
	function us(t, e) {
		const n = e instanceof $i ? e.components[0] : void 0,
			i = e instanceof $i ? e.components[1] : void 0,
			s = hs(n, t.x),
			o = hs(i, t.y);
		return Math.max(s, o);
	}
	...
	const bs = {
		...
		type: 'input',
		accept: (t, e) => {
			if (!Qi.isObject(t)) return null;
			const n = A,
				i = D(e, {
					expanded: n.optional.boolean,
					picker: n.optional.custom(rn),
					x: n.optional.custom(an),
					y: n.optional.object({
			...
			constraint: (t) => {
				return (
					...
					new $i({
						assembly: Ji,
						components: [
							cs('x' in e ? e.x : void 0, n.x),
							cs('y' in e ? e.y : void 0, n.y),
						],
					})
				);
				var e, n;
		...
		controller: (t) => {
			const e = t.document,
				n = t.value,
				i = t.constraint;
			if (!(i instanceof $i)) throw c.shouldNeverHappen();
			const s = 'expanded' in t.params ? t.params.expanded : void 0,
				o = 'picker' in t.params ? t.params.picker : void 0;
			return new ss(e, {
				axes: [
					vs(n.rawValue.x, i.components[0]),
					vs(n.rawValue.y, i.components[1]),
				],
				expanded: null != s && s,
				invertsY: ms(t.params),
				maxValue: us(n.rawValue, i),
				parser: Ee,
	...
	const ws = {
		...
		accept: (t, e) => {
			...
			const n = A,
				i = D(e, {
					x: n.optional.custom(an),
					y: n.optional.custom(an),
					z: n.optional.custom(an),
				});
			return i ? {initialValue: t, params: i} : null;
		},
		binding: {
		...
		controller: (t) => {
			const e = t.value,
				n = t.constraint;
			if (!(n instanceof $i)) throw c.shouldNeverHappen();
			return new qi(t.document, {
				assembly: rs,
				axes: [
					fs(e.rawValue.x, n.components[0]),
					fs(e.rawValue.y, n.components[1]),
					fs(e.rawValue.z, n.components[2]),
				],
				parser: Ee,
				value: e,
				viewProps: t.viewProps,
	...
	function xs(t) {
		return as.isObject(t) ? new as(t.x, t.y, t.z, t.w) : new as();
	}
	function Cs(t, e) {
		t.writeProperty('x', e.x),
			t.writeProperty('y', e.y),
	...
	const ys = {
		...
		type: 'input',
		accept: (t, e) => {
			if (!as.isObject(t)) return null;
			const n = A,
				i = D(e, {
					x: n.optional.custom(an),
					y: n.optional.custom(an),
					z: n.optional.custom(an),
					w: n.optional.custom(an),
				});
			return i ? {initialValue: t, params: i} : null;
		},
		binding: {
			...
			return new qi(t.document, {
				...
				axes: e.rawValue.getComponents().map((t, e) => {
					return (
						(i = t),
						{
							baseStep: cn((s = n.components[e])),
							constraint: s,
							textProps: L.fromObject({
								draggingScale: hn(s, i),
								formatter: Me(dn(s, i)),
							}),
						}
					);
	...
	const Ps = {
			...
			controller: (t) => {
				...
				return s
					...
					: new re(e, {
							parser: (t) => t,
							props: L.fromObject({formatter: je}),
							value: n,
							viewProps: t.viewProps,
					  });
			},
		},
		ks = {monitor: {defaultInterval: 200, defaultLineCount: 3}},
		Es = b('mll');
	class Vs {
		constructor(t, e) {
	...
	const Ds = {
			...
			accept: (t, e) => {
				if ('boolean' != typeof t) return null;
				const n = D(e, {lineCount: A.optional.number});
				return n ? {initialValue: t, params: n} : null;
			},
			binding: {reader: (t) => ae},
			controller: (t) => {
	...
	class Rs {
		constructor(t, e) {
			...
			const n = t.createElementNS(T, 'svg');
			n.classList.add(js('g')),
				(n.style.height = `calc(var(--bld-us) * ${e.lineCount})`),
				this.element.appendChild(n),
				(this.svgElem_ = n);
			const i = t.createElementNS(T, 'polyline');
			this.svgElem_.appendChild(i), (this.lineElem_ = i);
			const s = t.createElement('div');
			s.classList.add(js('t'), b('tt')()),
				this.element.appendChild(s),
				(this.tooltipElem_ = s),
				e.value.emitter.on('change', this.onValueUpdate_),
				(this.value = e.value),
		...
		update_() {
			...
			this.value.rawValue.forEach((o, r) => {
				if (void 0 === o) return;
				const a = He(r, 0, e, 0, t.width),
					l = He(o, n, i, t.height, 0);
				s.push([a, l].join(','));
			}),
				this.lineElem_.setAttributeNS(null, 'points', s.join(' '));
			const o = this.tooltipElem_,
				r = this.value.rawValue[this.cursor_.rawValue];
			if (void 0 === r) return void o.classList.remove(js('t', 'a'));
			const a = He(this.cursor_.rawValue, 0, e, 0, t.width),
				l = He(r, n, i, t.height, 0);
			(o.style.left = `${a}px`),
				(o.style.top = `${l}px`),
				(o.textContent = `${this.formatter_(r)}`),
				o.classList.contains(js('t', 'a')) ||
					(o.classList.add(js('t', 'a'), js('t', 'in')),
					F(o),
					o.classList.remove(js('t', 'in')));
		}
		onValueUpdate_() {
			this.update_();
		}
	...
	class Is {
		constructor(t, e) {
			if (
				...
				const t = new $e(this.view.element);
		...
		onGraphMouseMove_(t) {
			...
			this.cursor_.rawValue = Math.floor(
				He(t.offsetX, 0, e.width, 0, this.value.rawValue.length),
			);
		}
	...
	function Ks(t) {
		return 'format' in t && !a(t.format) ? t.format : Me(2);
	}
	function Ns(t) {
	...
	const Os = {
			...
			binding: {defaultBufferSize: (t) => (Ns(t) ? 64 : 1), reader: (t) => Ve},
			controller: (t) =>
				Ns(t.params)
					? (function (t) {
							var e, n, i;
							return new Is(t.document, {
								formatter: Ks(t.params),
								lineCount:
									null !== (e = t.params.lineCount) && void 0 !== e
										? e
										: ks.monitor.defaultLineCount,
	...
	function Fs(t, e) {
		return 0 === e
			? new Ht()
			: new zt(t, null != e ? e : ks.monitor.defaultInterval);
	}
	class $s {
		constructor() {
		...
		createInput(t, e, n) {
			if (a(e.read()))
				throw new c({context: {key: e.key}, type: 'nomatchingcontroller'});
					...
					null != i
						...
						: (function (t, e) {
								...
								const i = A,
									...
									r = t.binding.constraint ? t.binding.constraint(s) : void 0,
									l = V(o(n.initialValue), {
										constraint: r,
									...
									h = t.controller({
										...
										params: n.params,
										value: p.value,
										viewProps: N.create({disabled: d, hidden: c}),
									}),
									u = i.optional.string(e.params.label).value;
								return new pt(e.document, {
									binding: p,
									blade: nt(),
									props: L.fromObject({label: null != u ? u : e.target.key}),
									valueController: h,
								});
				...
				(i, s) =>
					null != i
						...
						: (function (t, e) {
								var n, i, s;
								const o = A,
									r = t.accept(e.target.read(), e.params);
								if (a(r)) return null;
								const l = {
										target: e.target,
											...
											(i =
												...
												void 0 !== n
													...
													: t.binding.defaultBufferSize &&
													  t.binding.defaultBufferSize(r.params)) &&
										void 0 !== i
											? i
											: 1,
									...
									m = t.controller({
										...
										params: r.params,
										value: h.value,
										viewProps: N.create({disabled: u, hidden: v}),
									}),
									b =
										...
										void 0 !== s
											? s
											: e.target.key;
								return new ct(e.document, {
									binding: h,
									blade: nt(),
									props: L.fromObject({label: b}),
									valueController: m,
								});
				...
				(n, i) =>
					null != n
						...
						: (function (t, e) {
								...
								if (!n) return null;
								const i = A.optional.boolean(e.params.disabled).value,
									s = A.optional.boolean(e.params.hidden).value;
								return t.controller({
									blade: nt(),
									document: e.document,
									...
									viewProps: N.create({disabled: i, hidden: s}),
								});
						  })(i, {document: t, params: e}),
				null,
			);
			if (!n) throw new c({type: 'nomatchingview', context: {params: e}});
			return n;
		}
		createBladeApi(t) {
			if (t instanceof pt) return new lt(t);
			if (t instanceof ct) return new dt(t);
			if (t instanceof Ct) return new mt(t, this);
	...
	const Gs = {
		...
		controller(t) {
			const e = new Xt(ln(t.params.options)),
				n = V(t.params.value, {constraint: e}),
				i = new te(t.document, {
					props: new L({options: e.values.value('options')}),
					value: n,
					viewProps: t.viewProps,
				});
			return new Vt(t.document, {
				blade: t.blade,
				props: L.fromObject({label: t.params.label}),
				valueController: i,
			});
		...
		api: (t) =>
			t.controller instanceof Vt && t.controller.valueController instanceof te
				? new Hs(t.controller)
				: null,
	};
	class Ys extends bt {
		...
		refresh() {
			this.controller_.rackController.rack.find(pt).forEach((t) => {
				t.binding.read();
			}),
				this.controller_.rackController.rack.find(ct).forEach((t) => {
					t.binding.read();
				});
		}
	}
	...
	const Qs = {
			...
			controller(t) {
				...
				const i = null !== (e = t.params.value) && void 0 !== e ? e : 0,
					s = new Yt({max: t.params.max, min: t.params.min}),
					o = new nn(t.document, {
						baseStep: 1,
						parser: Ee,
						sliderProps: new L({
						...
						textProps: L.fromObject({
							draggingScale: hn(void 0, i),
							formatter:
								null !== (n = t.params.format) && void 0 !== n ? n : Le,
						}),
						value: V(i, {constraint: s}),
						viewProps: t.viewProps,
					});
				return new Vt(t.document, {
					blade: t.blade,
			...
			api: (t) =>
				t.controller instanceof Vt && t.controller.valueController instanceof nn
					? new zs(t.controller)
					: null,
		},
		Js = {
			...
			api: (t) =>
				t.controller instanceof Vt && t.controller.valueController instanceof re
					? new qs(t.controller)
					: null,
		};
	function Ws(t, e, n) {
	...
	(t.BladeApi = e),
		(t.ButtonApi = u),
		(t.FolderApi = bt),
		(t.InputBindingApi = lt),
		(t.ListApi = Hs),
		(t.MonitorBindingApi = dt),
		(t.Pane = class extends Ys {
			constructor(t) {
				var e, n;
				const i = null != t ? t : {},
					s = null !== (e = i.document) && void 0 !== e ? e : H(),
					o = (function () {
						const t = new $s();
						return (
							[
				...
				super(
					new Xs(s, {
						expanded: i.expanded,
						blade: nt(),
						props: L.fromObject({title: i.title}),
						viewProps: N.create(),
					}),
					o,
				),
			...
			embedPluginStyle_(t) {
				t.css && Ws(this.document, `plugin-${t.id}`, t.css);
			}
			setUpDefaultPlugins_() {
				Ws(
					...
					this.registerPlugin({plugins: [Qs, Gs, $t, Js]});
			}
		}),
		(t.Point2d = Qi),
		(t.Point3d = os),
