...
(function (global, factory) {
	...
	class TpChangeEvent extends TpEvent {
		 ...
		 * @hidden
		 */
		constructor(target, value, presetKey, last, before) {
			super(target);
			this.value = value;
			this.presetKey = presetKey;
			this.last = last !== null && last !== void 0 ? last : true;
			this.before = before !== null && before !== void 0 ? before : true;
		}
	}
	/**
	...
	function createValue(initialValue, config) {
		const constraint =
			config === null || config === void 0 ? void 0 : config.constraint;
		const equals =
			config === null || config === void 0 ? void 0 : config.equals;
			...
			this.blade.value('positions').emitter.on('change', () => {
				getAllBladePositions().forEach((pos) => {
					elem.classList.remove(
						className$o(undefined, POS_TO_CLASS_NAME_MAP[pos]),
					);
				});
	...
	class InputBindingApi extends BladeApi {
		...
		onBindingChange_(ev) {
			...
			if (ev.options.beforeChange) {
				this.exBeforeChangeFalg = true;
			}
			if (!ev.options.beforeChange && this.exBeforeChangeFalg) {
				(_a = this.beforeChangeEventHandler) === null || _a === void 0
					? void 0
					: _a.call(this);
				this.exBeforeChangeFalg = false;
			}
	...
	const NumberInputPlugin = {
		...
		controller: (args) => {
			...
			const formatter =
				(_a = 'format' in args.params ? args.params.format : undefined) !==
					null && _a !== void 0
					? _a
	...
	function getSuitableMaxDimensionValue(constraint, rawValue) {
		...
		if (!isEmpty(min) || !isEmpty(max)) {
			return Math.max(
				Math.abs(min !== null && min !== void 0 ? min : 0),
				Math.abs(max !== null && max !== void 0 ? max : 0),
			);
		}
	...
	class InputBinding {
		...
		setValue(rawValue, isEmitt = false) {
		...
		return {
			...
			controller(args) {
				const lc = new ListConstraint(
					normalizeListOptions(args.params.options),
				);
