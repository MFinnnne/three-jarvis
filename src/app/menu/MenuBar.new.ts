        ...
        switch (type) {
            ...
            case 'PointLight':
                this.jarvis.recorder.execute(
                    new AddObjectCommand(this.jarvis.state.selectedObject, new PointLight(0xff0000, 1, 100)),
                );
                break;
            case 'SpotLight':
            ...
            case 'AmbientLight':
                this.jarvis.recorder.execute(
                    new AddObjectCommand(this.jarvis.state.selectedObject, new AmbientLight()),
                );
                break;
            case 'DirectionalLight':
                this.jarvis.recorder.execute(
                    new AddObjectCommand(this.jarvis.state.selectedObject, new DirectionalLight()),
                );
                break;
            case 'HemisphereLight':
                this.jarvis.recorder.execute(
                    new AddObjectCommand(this.jarvis.state.selectedObject, new HemisphereLight()),
                );
                break;
            case 'RectAreaLight':
                this.jarvis.recorder.execute(
                    new AddObjectCommand(this.jarvis.state.selectedObject, new RectAreaLight()),
                );
                break;
            default:
                break;
